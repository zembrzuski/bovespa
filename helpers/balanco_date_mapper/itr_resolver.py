...
def indices_to_date_itr(data_documento):
    return {
        'balanco': [
            balanco_mapper(data_documento),  # primeiro tri
            balanco_mapper(data_documento),  # segundo tri
            balanco_mapper(data_documento),  # terceiro tri
            balanco_mapper(data_documento),  # quarto tri
        ],
        'demonstrativo': [
